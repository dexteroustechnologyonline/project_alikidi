...
import { newsUpdate, updateNewsComment } from "../app/redux/news/NewsSlice";
...
console.log();
  // fetch data
  const product = await fetch(`${Baseurl}/api/v1/news/findbyurl/${newsUrl}`).then((res) => res.json())
...
const Page = ({ params }) => {
  ...
  //       `${Baseurl}/api/v1/news/findbyurl/${newsUrl}`
  //     );

  //     if (newssingle.data.success === true) {
  //       const singleNews = newssingle.data.news[0];
  //       let ulrWhatsappShare = `https://api.whatsapp.com/send/?text=https://alikidi.com/news-post-info/${newsUrl}`;
  //       setWhatsappMassage(ulrWhatsappShare);
  //       newsSingle = singleNews;

  //       if (singleNews.slider.length > 0) {
  //         // setNewsSlider(singleNews.slider);
  //         newsSlider1 = singleNews.slider;
      ...
      try {
        ...
        try {
          ...
          if (addComment.data.success) {
            ...
            newsSingle = updatednews;

            // setNewsSlider(updatednews.slider);
            newsSlider1 = updatednews.slider;
            ...
            <div className="col-lg-8 col-md-12">
              <div className="single-post">
                <div className="utf_post_title-area">
                  ...
                  <div className="utf_post_meta"></div>
                </div>
